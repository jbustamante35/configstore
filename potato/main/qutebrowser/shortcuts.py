...
config.bind(";uw", "set downloads.location.directory ~/Dropbox/Classes/uwmadison ;; hint links download")
config.bind(";ra", "set downloads.location.directory ~/Dropbox/ResearchArticles/computationalbiology/edgarspalding ;; hint links download")
config.bind(";es", "set downloads.location.directory ~/Dropbox/EdgarSpalding ;; hint links download")
