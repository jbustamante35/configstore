...
; (gtk_accel_path "<Actions>/ThunarLocationButtons/location-buttons-paste-into-folder" "<Primary>v")
...
; (gtk_accel_path "<Actions>/ThunarLocationButtons/location-buttons-open" "<Primary>o")
