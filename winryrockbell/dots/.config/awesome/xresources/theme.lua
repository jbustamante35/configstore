...
theme.mouse_finder_color = "xrdb.color0"
...
-- -- Generate wallpaper:
--
-- local wallpaper_bg     = xrdb.color2
-- local wallpaper_fg     = xrdb.color4
-- local wallpaper_alt_fg = xrdb.color10
...
theme.wallpaper = "/home/jbustamante/.config/wall.png"
